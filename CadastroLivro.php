...
<br><br>
        ...
        <input type="text" maxlength="300" name="Titulo" id="Titulo" placeholder="Nome da Obra" required>

        <h1>Subtítulo da Obra</h1>
        <input type="text" maxlength="300" name="Subitulo" id="Subitulo" placeholder="Subtítulo da Obra" required>

        <h1>Edição</h1>
        <input type="text" maxlength="50" name="Edicao" id="Edicao" placeholder="Edição da Obra" required>

        <h1>Autor</h1>
        <input type="text" maxlength="300" name="Autor" id="Autor" placeholder="Nome do autor ou autores" required>

        <h1>Editora</h1>
        <input type="text" maxlength="100" name="Edicao" id="Edicao" placeholder="Editora da Obra" required>
        ...
        <h1>Classificação</h1>
        <input type="number" maxlength="300" name="Class" id="Class" placeholder="Numero da Etiqueta do Livro" required>

        
        <h1>Palavras Chave</h1>
        <input type="text" maxlength="300" name="Keyword" id="Keyword" placeholder="Keywords">

        <h1>Lugar</h1>
        <input type="text" maxlength="50" name="Edicao" id="Edicao" placeholder="Localização da Obra" required>

        <h1>Nº do Livro</h1>
        <input type="text" maxlength="100" name="Edicao" id="Edicao" placeholder="Numero do Livro" required>
